    ...
    const tabs = [
        {
            ...
            value: "branding",
            content: (
                <div className="w-full h-auto bg-black card rounded-md flex flex-col-reverse md:flex-row">
        ...
        },
        {
            ...
            content: (
                <div className="w-full h-auto bg-black card rounded-md flex flex-col-reverse md:flex-row md:items-center">
    ...
    return (
        ...
        <div className="h-[20rem] md:h-96 [perspective:1000px] relative b flex flex-col max-w-5xl mx-auto w-full  items-start justify-start my-20 space-y-10">
            <div className="flex flex-col px-6 mx-auto ">
                <h1 className="text-3xl md:text-6xl text-white text-center font-bold">Usecase</h1>
